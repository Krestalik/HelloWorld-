...
public class CreatePrimitives : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject.CreatePrimitive(PrimitiveType.Cube).transform.position = new Vector3(0, 0, 0); //программа, создающую в начале игры фигуру, напоминающую Стива из Minecraft!
